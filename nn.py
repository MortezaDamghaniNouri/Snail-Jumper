...
class NeuralNetwork:
    ...
    def __init__(self, layer_sizes):
        ...
        """
        # This part is implemented based on that layer_sizes is always a list with three elements
    ...
    # This function is used for normalizing the input_list elements by passing them to activation function and returns the list of normal inputs
